...
public class CreateMatchCommand implements Command {
	...
	//private final static String MESSAGE_TO_CREATE_MATCH = "messageCreateMatch";

	// POST, но надо бы запомнить урл
	...
	public String execute(HttpServletRequest request, HttpServletResponse response) {
		...
		if (user != null && user.getRole().equals(ADMIN)) {
			...
			try {
				MatchBean match = new MatchBean(request.getParameter(MATCH_NAME), request.getParameter(COUPON_ID),
