...
public final class StatementTotalizator {
	...
	public final static String SELECT_COUPON_BY_ID = "SELECT `cupon_id`, `start_date`, `end_date`, `min_bet_amount`, `cupon_pull`, `jackpot`, `status_id` FROM `cupon` WHERE `cupon_id`=?;";
