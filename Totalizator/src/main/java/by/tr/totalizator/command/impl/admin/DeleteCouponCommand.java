...
/**
 * Implements {@link by.tr.totalizator.command.Command} to delete the chosen
 * coupon with it's matches. Available for admin.
 * 
...
public class DeleteCouponCommand implements Command {
	...
	private final static String RESULT = "resultDelete";
	...
	/**
	 * Provides the service to delete the chosen coupon with it's matches. This service
	 ...
	 * details operation. Sets <code>resultDelete</code> session variable as
	 * <code>true</code> in case of the correct ending of this operation and as
	 * <code>false</code> in case of failing this operation.
	 * </p>
	 * 
	 * @return an URL of command to go to the page with all coupons table, if the
