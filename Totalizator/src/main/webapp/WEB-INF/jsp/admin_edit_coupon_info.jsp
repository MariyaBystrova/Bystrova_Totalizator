	...
	<div class="main">
		...
		<div>
			...
			<form action="Controller" method="post">
				...
				<input type="hidden" name="coupon-id" value = "${requestScope.couponId}">
				<h2>Edit coupon:</h2>
				<div>
					<div>
					...
					<div>
						<input type="datetime-local" name="coupon-start-date"
							id="coupon-start-date" placeholder="yyyy-mm-dd hh:mm" value="${coupon.startDateString}"
							required="required" />
					</div>
				</div>
				<div>
					...
					<div>
						<input type="datetime-local" name="coupon-end-date"
							id="coupon-end-date" placeholder="yyyy-mm-dd hh:mm" value="${coupon.endDateString}"
							required="required" />
					</div>
				</div>
				<div>
					...
					<div>
						<input type="number" name="coupon-min-bet-amount"
							id="coupon-min-bet-amount" value="${coupon.minBetAmount}"required="required" />
					</div>
				</div>
				<div>
					<div>
						<label for="coupon-pull"><c:out
								value="Pull" />:</label>
					</div>
					<div>
						<input type="number" name="coupon-pull"
							id="coupon-pull" value="${coupon.pull}"required="required" />
					</div>
				</div>
				<div>
					<div>
						<label for="coupon-jackpot"><c:out
								value="Jackpot" />:</label>
					</div>
					<div>
						<input type="number" name="coupon-jackpot"
							id="coupon-jackpot" value="${coupon.jackpot}"required="required" />
					</div>
				</div>
				<div>
					<div>
