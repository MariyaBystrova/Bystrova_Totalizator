...
////        childs = line.childNodes;
////        
////    var startDate = childs[0].textContent,
////        endDate = childs[1].textContent,
////        minBetAmount = childs[2].textContent,
////        jackpot = childs[3].textContent,
////        status = childs[4].textContent;
//////    
...
//    inputCommand.setAttribute("value", "edit-coupon");
//    form.appendChild(inputCommand);
//    
//    var inputSd = document.createElement("INPUT");
//    inputSd.setAttribute("type", "datetime-local");
//    inputSd.setAttribute("name", "coupon-start-date");
//    inputSd.setAttribute("placeholder", "yyyy-mm-dd hh:mm");
//    inputSd.setAttribute("required","required");
//    var startDate = document.getElementById("startDate"+x);
//    inputSd.setAttribute("value", startDate.textContent.replace(" ", "T"));
//   // line.removeChild(document.getElementById("startDate"+x));
//    form.appendChild(document.getElementById("startDate"+x));
//    document.getElementById("startDate"+x).appendChild(inputSd);
//   
//    
//    var inputEd = document.createElement("INPUT");
//    inputEd.setAttribute("type", "datetime-local");
//    inputEd.setAttribute("name", "coupon-end-date");
//    inputEd.setAttribute("placeholder", "yyyy-mm-dd hh:mm");
//    inputEd.setAttribute("required","required");
//    var endDate = document.getElementById("endDate"+x);
//    inputEd.setAttribute("value", endDate.textContent.replace(" ", "T"));
//    line.removeChild(document.getElementById("endDate"+x));
